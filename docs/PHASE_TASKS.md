...
| [ ] | **F–M (communities) — Delivery extension (moderators / digest)** Outbound email/SMS to **moderators** on post report; batched digests — *in-app `community_post_reported` today* |
