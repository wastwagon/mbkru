...
const accountabilitySteps = [
  {
    ...
    description: "Annual report card on every Minister, Regional Minister, and MP. Data-driven performance assessment.",
  },
  {
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Published 90 days before every general election. Pre-election debates and town halls in every constituency.",
  },
];
