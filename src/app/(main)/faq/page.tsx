        ...
        <div className="mx-auto max-w-3xl">
          <div className="space-y-6">
            {faqPlaceholders.map((item, i) => (
              ...
              >
                <summary className="flex cursor-pointer list-none items-start justify-between gap-4 font-display text-lg font-semibold text-[var(--foreground)]">
                  {item.question}
          ...
          <p className="mt-10 text-center text-sm text-[var(--muted-foreground)]">
            Have another question? <a href="/contact" className="font-semibold text-[var(--primary)] hover:underline">Get in touch</a>.
          </p>
        </div>
      </section>
    </div>
