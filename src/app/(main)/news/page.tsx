      ...
      <section className="section-spacing section-full bg-[var(--section-light)]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="mb-8 rounded-xl border border-[var(--border)] bg-white px-4 py-3 text-center text-sm text-[var(--muted-foreground)] shadow-sm">
            Sample stories below. Run Postgres, migrate, seed an admin, then publish posts from{" "}
            <Link href="/admin" className="font-semibold text-[var(--primary)] hover:underline">
              /admin
            </Link>{" "}
            to replace this with live news.
          </p>
          <div className="grid gap-8 lg:grid-cols-2 lg:items-stretch lg:gap-10">
            <div className="group">
              <Link href={`/news/${featured.slug}`} className="block">
