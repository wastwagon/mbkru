        ...
        <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-[var(--border)] bg-white p-6 shadow-[var(--shadow-card)] sm:p-8">
            ...
            <details className="mt-4 rounded-xl border border-[var(--border)] bg-[var(--section-light)]/60 px-4 py-3 text-sm">
              <summary
                className={`min-h-10 cursor-pointer list-none rounded-lg px-1 py-1 -mx-1 -my-1 font-semibold text-[var(--foreground)] transition-colors marker:content-none [&::-webkit-details-marker]:hidden ${focusRingSmClass}`}
              >
