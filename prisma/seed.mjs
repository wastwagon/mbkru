...
const POSTS_SEED = [
  ...
  },
  {
    ...
    body: [
      "A civic summary of reported policy framing, Summit themes, and accountability questions. For practical help with passports and Ghana Card, use the **[Diaspora support hub](/diaspora)**.",
      "",
      "> **Last compiled for the site: January 2026.** Re-verify facts on official sites as policies and dates change.",
      "",
      "## Sixteen regions on the map — plus a policy “region” abroad",
      "",
      "Ghana has **sixteen administrative regions**. The phrase **“17th Region”** names the **global Ghanaian diaspora** as a policy constituency. This briefing draws on **public reporting** around the 2025 Diaspora Summit; verify details on primary sources as policies evolve.",
      "",
      ...
      "- Discourse on Africa–diaspora unity, historical justice, and reparations in line with wider Pan-African debates.",
      "- Emphasis on remittances and economic contribution alongside references to institutional follow-up: diaspora policy, missions' performance, consular services, and mobility measures.",
      "- References to heritage, culture, and tourism linkages as part of reconnecting diaspora communities with Ghana.",
      "",
      ...
      "",
      "**Policy, not only symbolism** — Public reporting describes the “17th Region” as a strategic repositioning of how the state engages Ghanaians abroad—not merely a slogan.",
      "",
      "**Diaspora Summit 2025** — Advanced at a Summit in Accra (19–20 December 2025), under the theme “Resetting Ghana: The Diaspora as the 17th Region.”",
      "",
      "**Economic weight of remittances** — Government and press reporting highlight remittance inflows comparable in scale to major export categories.",
      "",
      "**Institutional follow-through** — Reporting references plans for stronger diaspora institutions, clearer national policy, consular measures, and performance expectations for missions.",
      "",
      "## How MBKRU relates to this conversation",
      "",
      "- **Voice beyond borders** — Accountability must include everyone who holds a stake in Ghana's future, including Ghanaians overseas.",
      "- **Transparency on impact** — Large remittance flows deserve public conversation on jobs, infrastructure, and services.",
      "- **Citizens' empowerment** — Accessible information and institutions that respond strengthen domestic accountability.",
      "- **National development** — Connecting diaspora skills, capital, and networks to local priorities fits MBKRU's mission.",
      "",
      "MBKRU is **non-partisan**. We care whether public narratives translate into **measurable inclusion, transparency, and citizen power**.",
      "",
      "## Questions for citizens & diaspora",
      "",
      "**How can diaspora engagement stay accountable?** Publish clear metrics: remittance-linked projects, consular turnaround times, investment facilitation outcomes, and feedback loops.",
      "",
      "**What should citizens monitor?** Whether new institutions improve service delivery at home, reduce exploitation of returnees, and protect workers and communities receiving investment.",
      "",
      "**Where does MBKRU add value?** Non-partisan education, situational awareness, and structured voice so diaspora and domestic citizens alike can demand evidence-backed governance.",
      "",
      "## References (external)",
      "",
      "- [Ghana Information Services Department — economic plan & 17th Region framing](https://isd.gov.gh/ghana-declares-global-diaspora-its-17th-region-unveils-new-economic-plan/)",
      "- [Diplomatic Times — President Mahama at Diaspora Summit 2025](https://www.diplomatictimesonline.com/full-text-speech-of-president-mahama-at-diaspora-summit-2025/)",
      "- [Ghana News Agency — Accra Summit coverage (Dec 2025)](https://gna.org.gh/2025/12/mahama-urges-africa-diaspora-unity-as-reparations-debate-takes-centre-stage-at-accra-summit/)",
      "",
      "Citations for datasets across the site are on **[Data sources](/data-sources)**. For partnerships, see **[Partners](/partners)** or **[Contact](/contact)**.",
    ].join("\n"),
  },
  {
